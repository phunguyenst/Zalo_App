...
showToast('This is a message');
  ...
  const handleReqeustAddFriend = async () => {
    ...
    try {
        ...
        console.log('Search result:', newSearchResult);
        ...
        navigation.navigate('FriendInfo', { friendId: friendId, friendName: newSearchResult[0].fullName, friendAvatar: newSearchResult[0].profilePic});
      } else {
      ...
      window.alert('Error', 'An error occurred while adding friend. Please try again later.');
    }
  }
        ...
        <View style={{ flex: 4, backgroundColor: 'white' }}>
          <View style={{ flex: 1 }}>
            ...
            <View style={{ flexDirection: 'row', flex: 1, alignItems: 'center' }}>
              ...
              <View style={{ flex: 5, borderWidth: 1, borderColor: borderColor, flexDirection: 'row', height: 30, marginLeft: 15, borderRadius: 10 }}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <TouchableOpacity style={{ flex: 1, flexDirection: 'row', alignItems: 'center', marginLeft: 5 }}>
              <Image source={require("../images/peoplemayknow.png")} style={{ width: 25, height: 25, borderRadius: 2, margin: 15 }} />
              <Text style={{ fontSize: 16 }}>Những người bạn có thể biết</Text>
            </TouchableOpacity>
          </View>

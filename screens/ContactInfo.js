...
export default function ContactInfo({route, navigation}) {
    ...
    return (
        <View style={styles.container}>
            <View
                style= {{position: 'absolute', top: 0, left: 0, height: 300, width: '100%', backgroundColor: 'white', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 10}}
            >
                <Image
            ...
            <View style={styles.profileContainer}>
                ...
                <View style={styles.buttonContainer}>
                    <Button title="Nhắn tin" onPress={() => {navigation.navigate("ChatDetail")}} />

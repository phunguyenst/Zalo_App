...
const ShowRequestAddFriend = ({navigation}) => {
  ...
  const handleAddFriend = async (friendId) => {
    try {
      ...
      console.log('Error when sent friend request:', error);
    }
  }
        ...
        <View style={{ height: 75, flexDirection: "row" }}>
          <TouchableOpacity
            style={{
              ...
              borderBottomWidth: selectedTab === 'Đã nhận' ? 2 : 0,
              borderBottomColor: selectedTab === 'Đã nhận' ? '#006af5' : 'transparent'
            }}
          ...
          <TouchableOpacity
            style={{
              ...
              borderBottomColor: selectedTab === 'Đã gửi' ? '#006af5' : 'transparent'
            }}
                    ...
                    return (
                      <View>
                        <View style={styles.headerContainer}>
                          <Text style={styles.headerText}>{item.user.fullName}</Text>
                        </View>
                        ...
                        <Card.Title
                          ...
                          right={(props) => (
                            <View style={{ flexDirection: "row" }}>
                              <TouchableOpacity
                                style={{ borderRadius: 10, backgroundColor: "grey", padding: 5, margin: 5, height: 35, width: 70, alignItems: "center", justifyContent: "center" }}
                              >
                                <Text style={{ color: "white" }}>thu hồi</Text>
                              </TouchableOpacity>
                          ...
                          right={(props) => (
                            <View style={{ flexDirection: "row" }}>
                              <TouchableOpacity
                                ...
                                style={{ borderRadius: 10, backgroundColor: "green", padding: 5, margin: 5, height: 35, width: 70, alignItems: "center", justifyContent: "center" }}
                              >
                                <Text style={{ color: "white" }}>đồng ý kết bạn</Text>
                              </TouchableOpacity>
                              <TouchableOpacity
                                style={{ borderRadius: 10, backgroundColor: "grey", padding: 5, margin: 5, height: 35, width: 70, alignItems: "center", justifyContent: "center" }}
                              >

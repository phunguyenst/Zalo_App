  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{flex: 1.2, backgroundColor: "#1E90FF", flexDirection: "row",  alignItems:"center"}}>
        <Image style={{width: "15%", height: "40%", resizeMode: "contain"}} source={require("../onHome/image_view/avtchat_02.jpg")}
            onStartShouldSetResponder={() => navigation.navigate("ProfileScreen")}
        ></Image>
        <Text style={{fontSize: 15, fontWeight: "bold", fontFamily: "Roboto", color:"white"}}>Phusenpai</Text>
      </View>

		...
		<View style={styles.container}>
          ...
          <Text style={{ fontSize: 14, fontWeight: "bold", fontFamily: "Roboto" }}>Cài đặt chung</Text>
				...
				<TouchableOpacity onPress={logout}>
					<View style={{ flex: 1, backgroundColor: "#FFFFFF", justifyContent: "center", paddingLeft: "5%", flexDirection: "row" }}>
						<View style={{ width: '5%' }}>
							<SimpleLineIcons name="logout" size={24} color="red" />
						</View>
						<View style={{ width: '95%' }}>
							<Text style={{ fontSize: 14, fontWeight: "bold", fontFamily: "Roboto", marginLeft: 10 }}>Đăng xuất</Text>
						</View>
					</View>
				</TouchableOpacity>
			</View>
